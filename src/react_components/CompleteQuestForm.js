...
import { submitQuestProof } from '../firebase/general_quest_functions';
...
export default function CompleteQuestForm({ isOpen, onClose, quest }) {
  ...
  const handleSubmit = async (e) => {
    ...
    console.log("Submitting quest proof for quest:", quest);
      ...
      <div className="create-quest-form">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="cq-actions">
            <button type="button" onClick={onClose} className="cq-btn cq-cancel">Cancel</button>
            <button type="submit" className="cq-btn">Submit Proof</button>
          </div>
        </form>
      </div>
    </div>
